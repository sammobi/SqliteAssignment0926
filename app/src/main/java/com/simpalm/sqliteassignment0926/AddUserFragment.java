...
public class AddUserFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (args != null) {
            ...
            id = args.getInt(Util.KEY_ID);
            // get the value of all the edit text from the bundle
            String contact_name = args.getString(Util.KEY_NAME);
            String contact_number = args.getString(Util.KEY_NUMBER);
            String contact_dob = args.getString(Util.KEY_DOB);
            String contact_address = args.getString(Util.KEY_ADDRESS);
    ...
    private AsyncTask addUserTask = new AsyncTask<String, Void, String>() {
...
// call the sharedprefernce and get the username from sharepference and save it inside the username variable.
            ...
            username = mSharedPreferences.getString(Util.KEY_USERNAME, "");
